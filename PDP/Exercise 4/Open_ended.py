...
Modification1 : Code (semi - working)
Modification2 : Debugging
Modification3 : Documentation & Formatting
...
class Core_cum_Elective(CoreCourse, ElectiveCourse):
    """
    Represents a course that can be both a CoreCourse and an ElectiveCourse. (Diamond_Inheritance)

    This class inherits from CoreCourse and ElectiveCourse, allowing it to have properties and behaviors
    of both types of courses.

    Parameters:
    - course_code (str): The unique code of the course.
    - course_name (str): The name of the course.
    - credit_hours (int): The credit hours assigned to the course.
    - **kwargs: Additional keyword arguments for specifying course properties.

    Attributes:
    - required_prerequisites (list): A list of required prerequisites for the course.
    - available_terms (list): A list of available terms in which the course can be taken.
    - other_info (dict): Additional information about the course.

    Methods:
    - course_info(): Returns a formatted string containing information about the course.

    Example Usage:
    >>> course = Core_cum_Elective(
    ...     course_code="CE101",
    ...     course_name="Advanced Programming",
    ...     credit_hours=3,
    ...     required_prerequisites=["CE100"],
    ...     available_terms=["Fall", "Spring"],
    ...     other_info={"Instructor": "Dr. Smith", "Location": "Room 101"}
    ... )
    >>> print(course.course_info())
    Title: Advanced Programming, Director: Dr. Smith, Year: 3, Genre: CE101
    Required Prerequisites: CE100
